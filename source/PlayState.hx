...
class PlayState extends MusicBeatState
{
	...
	public static var curShit:Int = 0;
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'turnip':
				dialogue = CoolUtil.coolTextFile(Paths.txt('turnip/dialogueShit'));
		}
